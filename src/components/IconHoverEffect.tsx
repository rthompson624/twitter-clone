...
export function IconHoverEffect({ children, color }: IconHoverEffectProps) {
  ...
  const colorClasses = `outline-${appliedColor}-400 hover:bg-${appliedColor}-200 group-hover:bg-${appliedColor}-200 group-focus-visible:bg-${appliedColor}-200 focus-visible:bg-${appliedColor}-200`;
  ...
  // outline-green-400 hover:bg-green-200 group-hover:bg-green-200 group-focus-visible:bg-green-200 focus-visible:bg-green-200
